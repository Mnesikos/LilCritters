...
public class LCItems {
    ...
    public static final RegistryObject<Item> BALL_PYTHON_EGG = ITEMS_REGISTRAR.register("ball_python_egg", () -> new ZawaEggItem(LCEntities.BALL_PYTHON, new Item.Properties().stacksTo(16)));
    ...
    public static final RegistryObject<Item> BURROWING_OWL_EGG = ITEMS_REGISTRAR.register("burrowing_owl_egg", () -> new ZawaEggItem(LCEntities.BURROWING_OWL, new Item.Properties().stacksTo(16)));
    ...
    public static final RegistryObject<Item> SNAPPING_TURTLE_EGG = ITEMS_REGISTRAR.register("snapping_turtle_egg", () -> new ZawaEggItem(LCEntities.SNAPPING_TURTLE, new Item.Properties().stacksTo(16)));
