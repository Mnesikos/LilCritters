...
public class GuineaPigEntity extends ZawaLandEntity {
    public GuineaPigEntity(EntityType<? extends ZawaLandEntity> type, World world) {
        super(type, world);
    }

    public static AttributeModifierMap.MutableAttribute registerGuineaPigAttributes() {
