...
public class BullfrogEntity extends ZawaLandEntity implements SpeciesVariantsEntity, OviparousEntity, JumpingEntity {
    ...
    public BullfrogEntity(EntityType<? extends ZawaBaseEntity> type, Level level) {
        super(type, level);
    ...
    public static AttributeSupplier.Builder registerBullfrogAttributes() {
    ...
    public ItemStack getBreedEggItem() {
        return LCItems.BULLFROG_FROGSPAWN.get().getDefaultInstance();
    }
