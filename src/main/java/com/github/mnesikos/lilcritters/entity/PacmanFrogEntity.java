...
public class PacmanFrogEntity extends ZawaLandEntity implements JumpingEntity {
    ...
    public static AttributeModifierMap.MutableAttribute registerPacmanFrogAttributes() {
