...
public class ModEntities {
    ...
    public static void init() {
        int id = 1;
        EntityRegistry.registerModEntity(new ResourceLocation(Ref.MODID + ":treesquirrel"), EntityTreeSquirrel.class, "TreeSquirrel", id++, LilCritters.instance, 80, 1, true, 0x9D8B85, 0xC35D3A);
        EntityRegistry.registerModEntity(new ResourceLocation(Ref.MODID + ":boxturtle"), EntityBoxTurtle.class, "BoxTurtle", id++, LilCritters.instance, 80, 1, true, 0x61380B, 0xFFBF00);
