...
public class OpossumModel extends ZawaBaseModel<OpossumEntity> {
    ...
    public OpossumModel() {
        ...
        this.righthigh = new ModelRenderer(this, 43, 15);
        this.righthigh.setPos(-1.9F, 1.6F, 0.9F);
        this.righthigh.addBox(-1.0F, -0.5F, -1.5F, 2, 4, 3, 0.0F);
        this.setRotateAngle(righthigh, -0.20943951023931953F, 0.0F, 0.0F);
        ...
        this.lefthigh = new ModelRenderer(this, 43, 15);
        this.lefthigh.mirror = true;
        this.lefthigh.setPos(2.4F, 1.6F, 0.9F);
        this.lefthigh.addBox(-1.0F, -0.5F, -1.5F, 2, 4, 3, 0.0F);
        this.setRotateAngle(lefthigh, -0.20943951023931953F, 0.0F, 0.0F);
        ...
        this.lefthigh.addChild(this.legleft);
        this.tailbase.addChild(this.tailmiddle);
        this.hips.addChild(this.righthigh);
        ...
        this.righthigh.addChild(this.legright);
        ...
        this.hips.addChild(this.lefthigh);
    ...
    public void playMovementAnimation(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.lefthigh.xRot = MathHelper.cos(limbSwing * speed * 0.2F) * degree * -2.0F * limbSwingAmount - 0.21F;
        ...
        this.righthigh.xRot = MathHelper.cos(limbSwing * speed * 0.2F) * degree * 2.0F * limbSwingAmount - 0.21F;
